...
[7-9] religions are like stories, pointing to the Truth. They are not the Truth in itself. Many people confuse the stories of religion with Truth itself, they confuse the Way with the destination. This lead to confusion and ultimately the apparant death of god ("God is dead" as Nietzsche explained). Here, Agapism clearly presents religion as a tool for people to commence on a journey to seek the Truth, as a collaboration and as individuals, thus breathing back live into that which didn't die. It's "religion" or any truths presented in words should thus should not be confused with that what they point to.
...
[13] It would be nice to actualy release Agapism as an open religion. An open religion is not a concept that exists yet, but it embraces collaboration and values as described by Agapism. Releasing this document in a git repo is an example of practices that open religions may embrace. Religions could become forkable as open source software is forkable as well. Additionaly, they could chose to include a chat room (Discord/Mattermost), social media accounts (Twitter/Mastodon), anchor versions in the blockchain (possibly assisted with tools as mirror.xyz), tokeneconomics where people could cast their confidence for the best current versions, etc. Thus, open religions may become a concept that was born out of Agapism.
...
This is a living document, so significant changes may be made along the way. If you would like to keep a certain version of this text, please save a local copy since new versions will replace older ones.

Last edit was made on 2 January 2023.

[39] This is redundant and meager the time of the last edit can be found via Git. Perhaps you can just point readers here to the latest commit. "The time history of this document can be find in Github (link to repo)".
...
[47] Middle also came from mid. In the middle we find balance. Thus love may be said to yield balance.
[47] So many more examples can probably be found. While beautiful, it is not presented very convincing for me here. My main problem is that many words can probably be found to appear many times in holy texts. It seems to me as if you present this appearance of the word love accross religions as your main argument that love is the essence of every religion. This is obviously not the case (a similar comment was earlier given in https://twitter.com/EknirNL/status/1605865244819001344). I think I get what you are trying to point to here, but I think you can provide a much better argument than the simple appearance of the word accross influential traditions.
...
> **Love means: being in an open connection, where energy can flow freely.**

[56] What we commonly call "falling in love" is thus the sudden experience of the Life Force, flowing freely through your being. Artists often attempt to capture this feeling in their art which is readily consumed by their audience. The artist thus creates a medium that points to the experience which is so common among human beings (assuming most couples found each other through love). 
...
[57] Why do we need to understand that what we all already know? Isn't love the most natural thing we can feel? The easiest and most profound way of being?
...
[71] Love can also be with a "smaller" good such as a bird, a branch, a stone or a grain of sand. Ultimately, when love presents itself in more more and more relationships, the realization comes that life is the common denominator of these subjects. Three returns to One as life (subject) loving life (Object). 
...
### 2: where energy may flow freely
...
[88-89] Energy can flow in a relationship also when it is not based on love. It is this kind of relationships that cause unbalance. Unbalance is associated with suffering. Energy that flows being purely propelled by love is never out of balance. However, achieving such pure motivations for any action is not an easy task, perhaps impossible. Thus, ultimate balance may never be attained. Imperfection creates motion and motion is live. Should we therefore embrache suffering, our attempt to release ourselves from it and the knowledge that we perhaps never will?
...
[105] don't you also mean to follow here the common tradition to capitalize anything that points to God or is a synonym thereof
...
[150] some also say that the story of Adam and Eve point to this human condition. 
